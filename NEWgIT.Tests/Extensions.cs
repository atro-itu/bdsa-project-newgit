public static class Extensions
{
    public static void Seed(this Repository repo)
    {
        ...
        repo.Commit("Her kommer smølfe Cowboy Joe", new Signature("Lucas", "lucas@gmail.com", DateTimeOffset.Now), new Signature("Lucas", "lucas@gmail.com", DateTimeOffset.Now), options: opts);
        repo.Commit("Kom og se mit cowboy show", new Signature("Lucas", "lucas@gmail.com", DateTimeOffset.Now), new Signature("Lucas", "lucas@gmail.com", DateTimeOffset.Now), options: opts);
        ...
        repo.Commit("kommer der et tog og det er fyldt med guld", new Signature("Bank", "bank@gmail.com", DateTimeOffset.Now), new Signature("Bank", "bank@gmail.com", DateTimeOffset.Now), options: opts);
